...
awk '{ print $1+0.07,$2,$3,$4,$5,$6,$7}' $kota_besar_malut | gmt pstext -R -JM -O -K >> $psfile
...
gmt psbasemap -J -R$REGION -B$AXIS --MAP_LABEL_OFFSET=0.2 --FONT_ANNOT_PRIMARY=9p --FONT_LABEL=11p,Heveltica --MAP_FRAME_TYPE=inside --MAP_FRAME_WIDTH=0.1p -P -K -O -V -Lf$skala/1/50+lKM  >> $psfile

gmt pscoast -Dl -R115/135/-5/6.3333333333 -JM3.5c -W0.3,gray40 -Swhite -Ggray40 --MAP_FRAME_TYPE=inside -O -K -V -Blrbt -Y0.1 -X1.1>> $psfile
